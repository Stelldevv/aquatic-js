...
let camPath;
let animationMixers = [];
// const backgroundMusic = new Audio(`${assetsPath}sounds/backgroundMusic.mp3`);
//=======================
//=====THREEJS SETUP=====
//=======================
...
function createSubStatic(name) {
    StaticSubEntities.push(new StaticSubEntity(name));
    StaticSubEntities.forEach(s => s.mapSubEntity());
}
